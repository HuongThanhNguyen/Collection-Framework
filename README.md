...
For each implemention of the given interfaces, find a typical application of that implementation. Explanation may be asked for the choice of an implementation.
